...
`_generator` / `# Generated by` stamps, and the two weekly workflows that
`git add` the generator by name after rewriting a table inside it. A rename
buys history for the body and spends it across all of that.
