...
**What would settle it.** No DAX capture of `stimulus_bass_burst` exists from
any device; every capture in the archive is −18 dBFS, which is too quiet to
engage a protection limiter. So whether Windows also strips ~10 dB off loud bass
