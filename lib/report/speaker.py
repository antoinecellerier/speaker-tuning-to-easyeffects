...
`DOCTOR_WARN` arrive as bare names because two record types and a string
constant hold no state a patch would have to reach.
...
def unlisted_speaker_pin_finding(info: speakers.SpeakerInfo) -> Finding | None:
    ...
    return Finding(
        ...
        detail=f"Linux configured one internal speaker pin on this machine "
               ...
               "single stereo pair — HDA codecs ship more output pins than "
               "a laptop wires up. It is "
