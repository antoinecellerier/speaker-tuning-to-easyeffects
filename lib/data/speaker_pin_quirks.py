...
# to the codec's subsystem id, never the PCI one.
#
# Generated by tools/update_speaker_pin_quirks.py from upstream's Realtek quirk
# table (weekly, via .github/workflows/speaker-pin-quirks.yml). Which machines
...
# once derived (see PinQuirk above). Do not hand-edit.
_SPEAKER_PIN_QUIRKS = {
    ...
    (0x1025, 0x1826): PinQuirk("", pins="0x17 0x1b", since="6.16", codec_only=False),
    (0x1025, 0x182C): PinQuirk("", pins="0x17 0x1b", since="6.16", codec_only=False),
    (0x1025, 0x1844): PinQuirk("", pins="0x17 0x1b", since="6.16", codec_only=False),
    ...
    (0x1028, 0x097D): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x097E): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0A61): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0A62): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0B19): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0B1A): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    ...
    (0x1028, 0x0BEB): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0C0B): PinQuirk("", pins="0x14", since="6.11", codec_only=False),
    (0x1028, 0x0C0D): PinQuirk("", pins="0x14", since="6.11", codec_only=False),
    (0x1028, 0x0C0E): PinQuirk("", pins="0x14", since="6.11", codec_only=False),
    (0x1028, 0x0C28): PinQuirk("", pins="0x14 0x17", since="6.10", codec_only=False),
    (0x1028, 0x0C90): PinQuirk("", pins="0x17", since="7.2", codec_only=False),
    (0x1028, 0x0C94): PinQuirk("", pins="0x17", since="6.17", codec_only=False),
    (0x1028, 0x0C96): PinQuirk("", pins="0x17", since="6.17", codec_only=False),
    (0x1028, 0x0CBD): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0CBE): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0CBF): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0CC0): PinQuirk("", pins="0x14", since="6.11", codec_only=False),
    (0x1028, 0x0CC1): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0CC2): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    (0x1028, 0x0CC3): PinQuirk("", pins="0x17", since="6.11", codec_only=False),
    ...
    (0x103C, 0x8C17): PinQuirk("", pins="0x14 0x17", since="", codec_only=False),
    ...
    (0x17AA, 0x390D): PinQuirk("", pins="0x17", since="6.15", codec_only=False),
    ...
    (0x17AA, 0x391A): PinQuirk("alc287-yoga9-bass-spk-pin", pins="0x17", since="", codec_only=True),
    ...
    (0x17AA, 0x3926): PinQuirk("alc287-yoga9-bass-spk-pin", pins="0x17", since="", codec_only=True),
    (0x17AA, 0x394C): PinQuirk("alc287-yoga9-bass-spk-pin", pins="0x17", since="7.1", codec_only=True),
    (0x1A58, 0x2023): PinQuirk("", pins="0x14 0x17", since="", codec_only=False),
    (0x1A58, 0x300E): PinQuirk("", pins="0x14 0x17", since="", codec_only=False),
    (0x1E39, 0xCA14): PinQuirk("", pins="0x1b", since="6.19", codec_only=False),
    (0x1E50, 0x7036): PinQuirk("", pins="0x1b", since="", codec_only=False),
