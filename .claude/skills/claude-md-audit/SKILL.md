...
cross-device § numbers and quoted headings, and fails any
Finding/entry/Follow-ups number cited outside design-notes "Legacy numbers", and
`tests/test_layout.py`, which checks `tools/` paths. Verify the rest by hand:
